...
- Установлен prometheus через helm
- Включен kubeStateMetrics для сбора инфы о сущностях k8s
- Включены node exporter
- Развернуто 3 экземпляра reddit app в разных неймспейсах
- Настроен сбор метрик приложения reddit 
- Установлена grafana
- Добавлен dashboard мониторинга k8s
- Добавлены созданные ранее дашборды
- Заиспользован механиз templating в grafana 
